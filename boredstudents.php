...
<head>
    ...
    <title>Bored Students Throw Illegal Party</title>
</head>
<body>
    <header>
    ...
    <section class="dragboatrace">
        <img src="images/ehustudentsillegalparty.png" style="width: 60%;" alt="EHU Students Illegal House Party">
        <h2 id="h2s">‘Bored’ students slammed for having illegal house party during national lockdown</h2>
            <p id="ptext1">Footage shows a raid on a house with up to 30 people breaching Covid-19 regulations</p><br>
