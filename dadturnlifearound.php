...
<head>
    ...
    <title>Dad Turns Life Around</title>
</head>
<body>
    <header>
    ...
    <section class="dragboatrace">
        <img src="images/ehustudent.png" style="width: 60%;" alt="Former Student">
        <h2 id="h2s">Dad who lost both parents at 6 turns life around after breakdown</h2>
            <p id="ptext1">Stuart Baker faced multiple setbacks</p><br>
