...
<head>
    ...
    <title>Edge Hill Uni Wins Three Awards</title>
</head>
<body>
    <header>
    ...
    <section class="dragboatrace">
        <img src="images/ehuawards23.jpg" style="width: 60%;" alt="Edge Hill university Awards">
        <h2 id="h2s">Edge Hill University wins three Educate North Awards</h2>
        <p id="ptext1">Edge Hill University was the most decorated institution at this year’s prestigious Educate North Awards, claiming three awards and a high commendation. </p><br>
