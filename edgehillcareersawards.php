...
<head>
    ...
    <title>Edge Hill Uni Careers Awards</title>
</head>
<body>
    <header>
    ...
    <section class="dragboatrace">
        <img src="images/ehucareersawards.jpg" style="width: 60%;" alt="Edge Hill Careers Awards">
        <h2 id="h2s">Edge Hill celebrates students and businesses at careers awards evening</h2>
        <p id="ptext1">Edge Hill University held an awards ceremony recognising the students, academics and businesses who have demonstrated an exceptional commitment to employability. </p><br>
