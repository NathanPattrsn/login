...
<head>
    ...
    <title>Edge Hill Uni Hosts FlourishCafé</title>
</head>
<body>
    <header>
    ...
    <section class="dragboatrace">
        <img src="images/ehucafe.jpg" style="width: 60%;" alt="Edge Hill Cafe">
        <h2 id="h2s">Edge Hill hosts a FlourishCafé to encourage climate action in the community</h2>
        <p id="ptext1">Edge Hill has invited Ormskirk residents to attend the FlourishCafé, a space for people to discuss their ideas for protecting the environment and living sustainably. </p><br>
