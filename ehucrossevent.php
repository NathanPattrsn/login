...
<head>
    ...
    <title>Edge Hill Open Holy Cross Event</title>
</head>
<body>
    <header>
    ...
    <section class="dragboatrace">
        <img src="images/OpenDay.jpg" style="width: 60%;" alt="Open Day">
        <h2 id="h2s">Edge Hill Open Event at Holy Cross</h2>
        <p id="ptext1">If you’re looking to further your studies, come along to our Open Evening on Wednesday 10 May from 4pm – 7pm.</p><br>
