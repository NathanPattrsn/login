...
<head>
    ...
    <title>Edge Hill Teen Had Life Support Turned Off</title>
</head>
<body>
    <header>
    ...
    <section class="dragboatrace">
        <img src="images/ehustudent3.png" style="width: 60%;" alt="Student">
        <h2 id="h2s">'Beautiful' teenager who went on a Liverpool night out and never came home</h2>
            <p id="ptext1">Halle O'Brien's life support machine had to be turned off by her devastated family.</p><br>
