...
<head>
    ...
    <title>Edge Hill Uni Youth Justice System</title>
</head>
<body>
    <header>
    ...
    <section class="dragboatrace">
        <img src="images/ehusystem.jpg" style="width: 60%;" alt="Edge Hill Youth Justice System">
        <h2 id="h2s">Youth justice system leaves children at risk of being unheard.</h2>
            <p id="ptext1">New research has found that children whose participation in their own rehabilitation is supposed to be at the heart of youth justice often feel unheard.</p><br>
