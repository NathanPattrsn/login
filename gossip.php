...
<section id="s2">
        ...
        <article id="a3">
            ...
            <img src="images/ehustudentsillegalparty.png" alt="Edge Hill Students" id="artimg3" style="width: 36.5%">
            ...
            <a href="boredstudents.php" id="rmlink">Read More</a>
        </div>
        </article>
        <div class="column2">
        <article id="a4">
            <h3 id="a4h3">Student dressed as Holocaust victim made vile 'gassed joke'</h3>
            <img src="images/ehustudent2.png" alt="Edge Hill Student" id="artimg4" style="width: 30%">
            ...
            <a href="studentmakesvilejoke.php" id="rmlink">Read More</a>
        </article>
        </div>
    </section>
