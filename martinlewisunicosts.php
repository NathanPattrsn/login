...
<head>
    ...
    <title>Martin Lewis - Uni Costs</title>
</head>
<body>
    <header>
    ...
    <section class="dragboatrace">
        <img src="images/martinlewis.jpg" style="width: 60%;" alt="Martin Lewis">
        <h2 id="h2s">Martin Lewis' Money Saving Expert warns university costs to double for many students</h2>
            <p id="ptext1">Money Saving Expert Martin Lewis described 'seismic' changes coming to university fees</p><br>
            ...
            <p id="ptext2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><br>
            <p id="ptext2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><br>
            <p id="ptext2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><br></p>
</p><br>
