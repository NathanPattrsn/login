...
<head>
    ...
    <title>Raheem Sterling Uni Scholarships</title>
</head>
<body>
    <header>
    ...
    <section class="dragboatrace">
        <img src="images/rahsterling.png" style="width: 60%;" alt="Raheem Sterling">
        <h2 id="h2s">Raheem Sterling launches university scholarship fund</h2>
        <p id="ptext1">The England forward wants to improve social mobility for black people</p><br>
