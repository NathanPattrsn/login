...
<head>
    ...
    <title>Student dressed as Holocaust Victim</title>
</head>
<body>
    <header>
    ...
    <section class="dragboatrace">
        <img src="images/ehustudent2.png" style="width: 60%;" alt="Student">
        <h2 id="h2s">Student dressed as Holocaust victim made vile 'gassed joke'</h2>
            <p id="ptext1">The incoming Edge Hill SU president was accused of vile 'homophobic, sexist and transphobic' Facebook posts.</p><br>
